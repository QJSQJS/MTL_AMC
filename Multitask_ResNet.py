...
####################################### ResNet #########################################
m=Lambda(lstmslice)(m)
x = residual_stack(m)  # output shape (32,64)
...
output_class = Reshape([len(classes)],name='class_out')(x)
...
save_dir = './joint_auto_resnet_64_maxpooling12_bc_426/'
...
duration = end - start
print('mutil-resnet testing time = ' + str(duration) + 's')
...
print(acc_complex)
np.save(save_dir + 'acc_joint_auto_amc_loss_50epoch.npy',acc_complex)
